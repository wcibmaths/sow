/* ══════════════════════════════════════════════════════════════════
   ...
   Sources (official Pearson timetables):
     ...
     IAL   Summer 2027   — final       ial-summer-2027-final.pdf
     IGCSE Summer 2027   — final       int-gcse-summer-2027-final.pdf

   All five timetables are Pearson FINAL versions. Note that the IAL
   Summer 2027 final moved four papers from the earlier provisional
   (FP2, M2, P4 and FP3) — these rows follow the final.

   Availability by series (this department's units only):
     October       IAL P1-P4, M1, M2, S1, S2 only.
                   No Further Pure, no D1, no S3, no M3.
     November      IGCSE Mathematics A only.
     January       IAL full range. International GCSE has NO January
                   series, so 4MA1 cannot be sat in January.
     May/June      Everything.
...
const EXTERNAL_EXAMS = [
  ...
  {date:'2027-06-03', series:'may-june', exam:'IAL Further Maths', paper:'FP2 Further Pure 2',   code:'WFM02', session:'PM', yg:'Year 13 FM FP1/FP2'},
  {date:'2027-06-04', series:'may-june', exam:'IAL Mathematics', paper:'M2 Mechanics 2',         code:'WME02', session:'PM', yg:'Year 13 FM M2'},
  {date:'2027-06-07', series:'may-june', exam:'IAL Mathematics', paper:'P4 Pure Mathematics 4',  code:'WMA14', session:'PM', yg:'Year 13 P3/P4'},
  {date:'2027-06-08', series:'may-june', exam:'IAL Further Maths', paper:'FP3 Further Pure 3',   code:'WFM03', session:'PM', yg:'Year 13 FM'},
...
/* Short labels for the "not offered this series" line on the dashboard. */
const EXTERNAL_UNIT_LABELS = {
  '4MA1':'IGCSE Maths A',
  'WMA11':'P1','WMA12':'P2','WMA13':'P3','WMA14':'P4',
  'WST01':'S1','WST02':'S2','WST03':'S3',
  'WME01':'M1','WME02':'M2','WME03':'M3',
